...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"E:\projectsof 2023\Facial-Recognition-for-Crime-Detection-master\img\back.png")
...
def getPage5():
    ...
    basicPageSetup(5)
    heading.configure(text="Image Colorisation")
    right_frame.configure(text="colorization", fg="white")

    btn_grid = tk.Frame(right_frame, bg="#3E3B3C")
    btn_grid.pack()


    tk.Button(btn_grid, text="Recognize", command=colorize, font="Arial 15 bold", padx=20, bg="#000000",
              fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#3E3B3C",
              activeforeground="white").grid(row=0, column=1, padx=25, pady=25)
...
def getPage6():
    ...
    basicPageSetup(6)
    heading.configure(text="Image Deblur")
    right_frame.configure(text="Deblur", fg="white")

    btn_grid = tk.Frame(right_frame, bg="#3E3B3C")
    btn_grid.pack()


    tk.Button(btn_grid, text="deblur", command=deblur, font="Arial 15 bold", padx=20, bg="#000000",
           fg="white", pady=10, bd=0, highlightthickness=0, activebackground="#3E3B3C",
           activeforeground="white").grid(row=0, column=1, padx=25, pady=25)
...
def deblur():
    ...
    img_size = right_frame.winfo_height() - 20
    showImage(sharpened2, img_size)
...
def colorize():
    ...
    # file_name = os.path.join('./model/images')
    ...
    cv2.imwrite('./model/images/color.png', colorized)
    img_size = right_frame.winfo_height() - 40
    showImage(img, img_size)
    img_read = cv2.imread('./model/images/color.png')
...
logo = tk.PhotoImage(file = r"E:\projectsof 2023\Facial-Recognition-for-Crime-Detection-master\img\logo2.png")
...
tk.Button(btn_frame, text="Image Colorization", command=getPage5)
tk.Button(btn_frame, text="Image Deblurring", command=getPage6)


for btn in btn_frame.winfo_children():
    btn.configure(font="Arial 20", width=15, bg="#000000", fg="white",
        pady=5, bd=0, highlightthickness=0, activebackground="#3E3B3C", activeforeground="white")
    btn.pack(pady=15)
