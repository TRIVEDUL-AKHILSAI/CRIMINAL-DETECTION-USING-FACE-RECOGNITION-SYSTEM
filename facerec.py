...
size = 2
haar_cascade = cv2.CascadeClassifier(r'E:\projectsof 2023\Facial-Recognition-for-Crime-Detection-master\face_cascade.xml')

# Part 1: Create fisherRecognizer
def train_model():
    model = cv2.face.LBPHFaceRecognizer_create()
    fn_dir = r'E:\projectsof 2023\Facial-Recognition-for-Crime-Detection-master\face_samples'
